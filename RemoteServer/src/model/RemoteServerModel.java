...
/**
 * The Class RemoteServerModel.
 */
public class RemoteServerModel extends Observable implements Model {
	...
	/**
	 * Instantiates a new remote server model.
	 *
	 * @param serverProperties
	 *            the server properties
	 */
	public RemoteServerModel(RemoteServerProperties serverProperties){
		try {
