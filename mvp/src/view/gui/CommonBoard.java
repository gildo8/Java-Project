...
/**
 * The Class CommonBoard implements Board's Interface .
 */
public abstract class CommonBoard extends Composite implements Board {
	...
	/**
	 * Sets the asked for solution.
	 *
	 * @param userAskedForSolution the new asked for solution
	 */
	public abstract void setAskedForSolution(boolean userAskedForSolution);
}
